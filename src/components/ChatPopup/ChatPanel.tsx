...
const suggestions: SuggestionItem[] = [
  { label: "What is BFFless?", prompt: "What is BFFless?" },
  {
    label: "How do I get started?",
    prompt: "How do I get started with BFFless?",
  },
  {
    label: "How do pipelines work?",
    prompt: "How do pipelines work in BFFless? What can I build with them?",
  },
];
...
export function ChatPanel({ onClose, onNewChat }: ChatPanelProps) {
  ...
  if (isLoadingHistory) {
    return (
      <div className="flex h-full flex-col rounded-2xl border border-cream-dark bg-white/90 backdrop-blur-lg shadow-2xl">
        <ChatHeader
          status="ready"
          hasMessages={false}
          onNewChat={onNewChat}
